<%-- 
    Document   : Update_Successfully
    Created on : Mar 23, 2025, 1:49:08 PM
    Author     : Lenovo
--%>
    ...
    <body>
        <form action="thanh-cong" method="GET">
            <div style="text-align: center; margin-top: 50px;">
                <h1 style="color: #28a745;">Cập Nhập thành công!</h1>
                <p style="font-size: 18px; margin: 20px 0;">Thông tin của bạn đã được lưu vào hệ thống</p>
