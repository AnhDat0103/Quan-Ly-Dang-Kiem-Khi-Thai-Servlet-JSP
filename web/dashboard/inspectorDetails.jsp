...
<html lang="en">
    <head>
        ...
        <title>Cập Nhật Thông Tin Công Nhân Đăng Kiểm</title>
            ...
            <div id="layoutSidenav_content">
                <div class="container-fluid form-update-station mt-4">
                    ...
                    <div class="form-header">
                        <h2>Cập Nhật Thông Tin Công Nhân Đăng Kiểm</h2>
                        <p>Vui lòng điền đầy đủ thông tin bên dưới</p>
                    </div>

                    <form action="cap-nhat-inspector" method="POST" id="updateForm" onsubmit="return validateForm()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" 
                                   value="${inspector.email}" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" 
                                   value="${inspector.fullName}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="address" name="address" 
                                   value="${inspector.address}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" 
                                   value="${inspector.phone}" required pattern="[0-9]{10}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="station">
                                <c:forEach items="${stations}" var="s">
                                    <option value="${s.stationId}" ${s.stationId == inspector.inspectionStation.stationId ? 'selected' : ''}>${s.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="button-group">
                            ...
                            <a href="danh-sach-nhan-vien-kiem-dinh?stationId=${requestScope.inspector.inspectionStation.stationId}" class="btn btn-secondary">
