...
public class User {
    ...
    public User(int userId, String fullName, String email, String password, RoleEnums role, String phone, String address,ProviderClass provider, InspectionStation inspectionStation) {
        this.userId = userId;
